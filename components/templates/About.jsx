const About = () => (
  <div className='container mx-auto flex flex-col gap-4 justify-center items-center h-full'>
    ...
    <p className='text-justify px-10 pb-10 leading-6 text-slate-600'>
      ...
      estos productos en su ciudad o puestos. Dedicamos nuestro esfuerzo a
      encontrar los mejores precios junto a esa calidad y tranquilidad que os
      brindamos encontrando a los mejores proveedores a nivel de tiempo y
      seguridad en el envio. Los mejores precios para que saques el mayor
      ...
      jovenes emprendedores que despues de ver la venta de estos productos y
      nunca encontrar ninguna Gan-Ga para tener un buen profit, optamos por
      sudar y conseguirlo nosotros. Poner vuestra confianza en nosotros y os
      prometemos no fallaros. Take My Vape.
    </p>
  </div>
)
